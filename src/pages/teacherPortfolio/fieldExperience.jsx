  ...
  return (
    ...
    <div className="container py-4">
      ...
      <section className="mb-5">
        <h2 className="mb-3 darkBlueText"><i className="bi bi-person-workspace me-2"></i>Teaching Experience</h2>
        <p>This semester, I cadet taught under <strong>Mrs. Collins</strong>, an Engineering and Technology teacher, working with <strong>7th and 8th grade students</strong> at <strong>Hamilton Southeastern Intermediate/Junior High</strong> in Fishers, Indiana. My experience included assisting with lessons, observing classroom management, and working directly with students on hands-on engineering and technology projects.</p>
      </section>

      {/* School Demographics */}
      <section className="mb-5">
        <h2 className="mb-3 darkBlueText"><i className="bi bi-building me-2"></i>School Demographics</h2>
      ...
      {/* Collage Section */}
<section className="mb-5">
  <h2 className="mb-3 darkBlueText"><i className="bi bi-camera me-2"></i>Field Experience Photos</h2>
  <p>Here are some highlights from my cadet teaching experience, including classroom activities, student engagement, and the school environment.</p>
