...
const essay = [
  ...
  "The first part of his role involves the physical security of the building, walking the hallways, checking for propped doors, looking for anything suspicious or out of the ordinary, and making sure both students and staff feel safe. He also uses a range of technology tools every day, including security cameras, daily reporting systems, Skyward, HSE Report It, and a platform called ICAT for handling cybercrime reports. Technically, physical security is the only thing required of the position, but many officers, including him, go far beyond that.",
  ...
  "When I asked him to describe a time when he made a significant impact on a student, he said that every student whose day he improves counts as an accomplishment. The most rewarding moments, he explained, are when a student recognizes their own worth and realizes they are worth fighting for. Watching a student's grades improve or their behavior turn around, that never gets old.",
  "We then walked the school together and checked in on students in the hallways. It happened to be school wide testing day for 7th and 8th graders, so we also stepped outside with a group of 5th grade teachers who had taken their students out to play math games in the weather. We made sure the area stayed safe and that the noise level stayed manageable for the students testing inside.",
